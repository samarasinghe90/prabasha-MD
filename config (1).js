const fs = require('fs-extra') 
 ...
 //═══════[Required Variables]════════\\ 
 global.owner = process.env.OWNER_NUMBER.split("94704519149") 
 ...
 global.sudo = process.env.SUDO || '94704519149' 
 global.devs = '94704519149'; 
 global.website = 'https://github.com/' //wa.me/+94704519149 
 global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/fb7993e24f7ecdaecbed5.jpg' 
 module.exports = { 
   botname:   process.env.BOT_NAME === undefined ? 'prabasha-Md' : process.env.BOT_NAME, 
   ownername: process.env.OWNER_NAME === undefined ? 'prabasha' : process.env.OWNER_NAME,  
